...
public class RenderLiveCommand extends Command
{
    public RenderLiveCommand() { super("rl"); }
    ...
    {
        if(args.length > 0) { Game.renderLive = isTrue(args[0]); }
        else { Game.renderLive = !Game.renderLive; }
        return true;
    }
}
