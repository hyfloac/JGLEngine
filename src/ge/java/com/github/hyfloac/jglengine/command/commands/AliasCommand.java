...
import com.github.hyfloac.jglengine.command.CommandHandler;
import com.github.hyfloac.jglengine.command.commands.exception.CommandUsageException;

public class AliasCommand extends Command
{
    public AliasCommand() { super("alias"); }

    @Override
    public String getUsage()
    {
        return "/alias <S:ORIGINAL_COMMAND> <S:ALIAS>";
    }
